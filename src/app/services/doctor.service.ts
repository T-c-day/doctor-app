...
const getByProviderURL = "/GetDoctorBySpecialty"
...
export class DoctorService {
  ...
  getDoctorsBySpecialty(spec:string, pro:string): Observable<Doctor[]>
  {
    return this.httpClient.get<Doctor[]>(doctorURL + getByProviderURL + "/" + spec + "/" + pro)
      .pipe(
        retry(1),
        catchError(this.errorHandler)
      );
